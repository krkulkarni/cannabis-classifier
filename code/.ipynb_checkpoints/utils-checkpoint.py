...
from sklearn.model_selection import StratifiedShuffleSplit, KFold, StratifiedKFold, GridSearchCV
from sklearn.calibration import CalibratedClassifierCV
from sklearn.metrics import confusion_matrix, plot_roc_curve, roc_auc_score, roc_curve, auc, accuracy_score
...
##########################################################################
# Define project root directories - clean up into single...
##########################################################################

base_dir     = '/Volumes/synapse/projects/SocialSpace/Projects/Cannabis_classification'
data_dir     = base_dir + '/data'
analysis_dir = base_dir + '/analyses/stanford_compcor_model/decoding'
feat_mat_dir = analysis_dir + '/feature_matrices'
training_dir = analysis_dir + '/training'
gridsrch_dir = training_dir + '/grid_search'

synapse_dir  = '/Volumes/synapse/projects/MJCraving/ConnSig/stanford_compcor_model'
betas_dir    =  synapse_dir + '/beta_parcellations'
